...
El código de este primer ejemplo de hola mundo se encuentra en el siguiente [enlace]{:target="_blank"}(https://github.com/maldiny/SpringBoot-en-Castellano/tree/master/Ejemplos/SpringBootHolaMundo).
